...
x_train=pd.read_csv('DATA/x_train.csv', encoding='euckr')
x_test=pd.read_csv('DATA/x_test.csv', encoding='euckr')
y_train=pd.read_csv('DATA/y_train.csv', encoding='euckr')
